...
ALTER TABLE `t_problem`
    ADD FOREIGN KEY (`knowledge_point_id`) REFERENCES `t_knowledge_point` (`id`);
ALTER TABLE `t_problem_description`
    ADD FOREIGN KEY (`problem_id`) REFERENCES `t_problem` (`id`);
ALTER TABLE `t_favorite`
    ADD FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`);
ALTER TABLE `t_favorite`
    ADD FOREIGN KEY (`problem_id`) REFERENCES `t_problem` (`id`);
ALTER TABLE `t_recommend_problem`
    ADD FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`);
ALTER TABLE `t_recommend_problem`
    ADD FOREIGN KEY (`problem_id`) REFERENCES `t_problem` (`id`);
ALTER TABLE `t_comment_student`
    ADD FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`);
ALTER TABLE `t_comment_student`
    ADD FOREIGN KEY (`problem_id`) REFERENCES `t_problem` (`id`);
...
ALTER TABLE `t_comment_teacher`
    ADD FOREIGN KEY (`problem_id`) REFERENCES `t_problem` (`id`);
ALTER TABLE `t_model_output_knowledge`
    ADD FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`);
ALTER TABLE `t_model_output_knowledge`
    ADD FOREIGN KEY (`knowledge_point_id`) REFERENCES `t_knowledge_point` (`id`);
ALTER TABLE `t_model_output_score`
    ADD FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`);